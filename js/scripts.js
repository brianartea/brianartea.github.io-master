...
(function ($) {
	...
	if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
		...
		parallaxHome.parallax("50%", 0);
		parallaxFacts.parallax("50%", 0);
		parallaxQuote.parallax("50%", 0);
		parallaxSkills.parallax("50%", 0);
		parallaxTest.parallax("50%", 0);
		parallaxContact.parallax("50%", 0);
		parallaxSlider.parallax("50%", 0);
	}
...
----------------------------------------------------- */
	$(".typed-element").typed({
		strings: ["Creative.", "Web Designer.", "Web Developer.", "Coder.", "Programmer."],
		typeSpeed: 10,
		loop: true,
		backDelay: 2000
	});
